  ...
  return (
    <header className='sticky left-0 bottom-0 shadow-md z-40'>
        <nav className='h-[72px] min-h-full w-full flex items-center justify-between bg-red-300'>
                <li className='list-none ml-14'><AboutModal /></li>
                {state === 2 ?
                  <>
                    <li className='list-none mr-14'><button className={`${buttonClasses} flex items-center justify-center`} onClick={handleLogout}><BiLogOut className="text-lg inline mr-2" />Log Out</button></li>
                  </>
                :
                  null
                }
