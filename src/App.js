  ...
  return (
    <>
      ...
      <main className="flex flex-col items-center justify-center">
        <div id="todo-input" className="flex flex-col items-center mt-5 text-xl sm:flex-row ">
          <input
            type="text"
            ref={todoTaskRef}
        ...
        <div id="todo-container" className="max-w-xs mt-5 text-xl sm:max-w-xl lg:w-1/2">
          <TodoList
            todos={todos}
